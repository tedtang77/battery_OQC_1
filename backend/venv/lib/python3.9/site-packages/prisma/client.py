...
SCHEMA_PATH = Path('/Users/tedtang/Codes/projects/2025-08_電池OQC/battery_OQC_1/database/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/tedtang/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin-arm64'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    batterycell: 'actions.BatteryCellActions[models.BatteryCell]'
    batchprocess: 'actions.BatchProcessActions[models.BatchProcess]'
    ...
    def __init__(
        ...
        *,
        ...
        self.batterycell = actions.BatteryCellActions[models.BatteryCell](self, models.BatteryCell)
        self.batchprocess = actions.BatchProcessActions[models.BatchProcess](self, models.BatchProcess)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/tedtang/Codes/projects/2025-08_電池OQC/battery_OQC_1/database/schema.prisma',
        }
...
class Batch:
    batterycell: 'BatteryCellBatchActions'
    batchprocess: 'BatchProcessBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.batterycell = BatteryCellBatchActions(self)
        self.batchprocess = BatchProcessBatchActions(self)
...
class BatteryCellBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.BatteryCellCreateInput,
        include: Optional[types.BatteryCellInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.BatteryCell,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.BatteryCellCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.BatteryCellWhereUniqueInput,
        include: Optional[types.BatteryCellInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.BatteryCellUpdateInput,
        where: types.BatteryCellWhereUniqueInput,
        include: Optional[types.BatteryCellInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.BatteryCellWhereUniqueInput,
        data: types.BatteryCellUpsertInput,
        include: Optional[types.BatteryCellInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.BatteryCellUpdateManyMutationInput,
        where: types.BatteryCellWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.BatteryCell,
    ...
    def delete_many(
        self,
        where: Optional[types.BatteryCellWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.BatteryCell,
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class BatchProcessBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.BatchProcessCreateInput,
        include: Optional[types.BatchProcessInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.BatchProcess,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.BatchProcessCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.BatchProcessWhereUniqueInput,
        include: Optional[types.BatchProcessInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.BatchProcessUpdateInput,
        where: types.BatchProcessWhereUniqueInput,
        include: Optional[types.BatchProcessInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.BatchProcessWhereUniqueInput,
        data: types.BatchProcessUpsertInput,
        include: Optional[types.BatchProcessInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.BatchProcessUpdateManyMutationInput,
        where: types.BatchProcessWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.BatchProcess,
    ...
    def delete_many(
        self,
        where: Optional[types.BatchProcessWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.BatchProcess,
